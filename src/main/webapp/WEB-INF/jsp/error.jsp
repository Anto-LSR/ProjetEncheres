    ...
    <g fill="none" fill-rule="evenodd">
      ...
      <g>
		...
		<h1 class="error-title">
			Woops! <br>T'es mauvais 😋
		</h1>
		<h2 class="error-subtitle">Envisage une reconversion, Jardinier
			peut être?</h2>
		<a href="${pageContext.request.contextPath }/"><button>Revenir
				à l'accueil</button></a>
